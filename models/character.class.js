class Character extends MoveableObject {
  ...
  constructor() {
    ...
    this.loadImages(this.IMAGES_HURT); // Bilder vom Springen im Array zu (IMAGES_HURT)
    this.loadImages(this.IMAGES_DEAD); // Bilder vom Springen im Array zu (IMAGES_DEAD)
